...
<div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <form action="<?php echo e(route('users.logout')); ?>" method="POST" class="d-inline">
            <?php echo csrf_field(); ?>
        ...
        <div class="main-panel">
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                    <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">&copy; <?php echo e(date('Y')); ?>. Tous droits réservé à Moi</span>
...
<?php /**PATH C:\Users\etudiant\Desktop\ProjetIlS6\backend-ams-il\resources\views/layout.blade.php ENDPATH**/ ?>